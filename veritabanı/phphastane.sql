...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 01 Şub 2019, 05:33:27
...
CREATE TABLE `ameliyatlar` (
  `id` int(11) NOT NULL,
  `hastaadi` varchar(30) COLLATE utf8_turkish_ci NOT NULL,
  `tarih` date NOT NULL,
  `ameliyat` varchar(30) COLLATE utf8_turkish_ci NOT NULL,
  `ameliyathane` int(11) NOT NULL,
  `doktor` varchar(30) COLLATE utf8_turkish_ci NOT NULL
...
CREATE TABLE `doktorlar` (
  `dkullaniciadi` varchar(30) COLLATE utf8_turkish_ci NOT NULL,
  `dsifre` varchar(30) COLLATE utf8_turkish_ci NOT NULL,
  `dalan` varchar(30) COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
('iremyedekci', '1234', 'plastik cerrahi');
...
CREATE TABLE `hastalar` (
  ...
  `yatisnedeni` varchar(500) COLLATE utf8_turkish_ci NOT NULL,
  `doktor` varchar(100) COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
INSERT INTO `hastalar` (`id`, `hastaadi`, `yatistarihi`, `odano`, `yatisnedeni`, `doktor`) VALUES
(2, 'irem', '2019-01-01', 1, 'burun estetiÄŸi', 'iremyedekci'),
(3, 'burcu', '2019-02-22', 3, 'yaÄŸ aldÄ±rma', 'iremyedekci');
...
CREATE TABLE `muayeneler` (
  ...
  `hastaadi` varchar(30) COLLATE utf8_turkish_ci NOT NULL,
  `tarih` date NOT NULL,
  `sikayet` varchar(400) COLLATE utf8_turkish_ci NOT NULL,
  `doktor` varchar(30) COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `tahliller` (
  ...
  `hastaadi` varchar(30) COLLATE utf8_turkish_ci NOT NULL,
  `tarih` date NOT NULL,
  `tahlil` varchar(100) COLLATE utf8_turkish_ci NOT NULL,
  `doktor` varchar(30) COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
('root', '[{\"db\":\"hastane\",\"table\":\"hastalar\"},{\"db\":\"hastane\",\"table\":\"tahliller\"},{\"db\":\"hastane\",\"table\":\"ameliyatlar\"},{\"db\":\"hastane\",\"table\":\"muayeneler\"},{\"db\":\"hastane\",\"table\":\"doktorlar\"}]');
...
('root', '2019-02-01 04:32:29', '{\"lang\":\"tr\",\"Console\\/Mode\":\"collapse\"}');
