...
<div class="w3-container">
    ...
    <div class="w3-card-4">
      <div style="position:fixed;top:10px;left:50px;">
        <h1 style="color:lightgreen">Ameliyat Randevusunu Silmek İstediğiniz Hastanın Numarasını Seçin:</h1>
      </div>

      <form class="w3-container" action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
        <p>
		 <i class="fa fa-user-times" style="font-size:48px;color:lightgreen"></i><label style="color:lightgreen"> Hasta Numarası</label></p>
          <input class="w3-input w3-border" name="hastano" type="text">
        <p>
          <input type="submit" name="silbtn" class="w3-btn w3-right w3-large w3-border" style="color:lightgreen" value="SİL"></p>
      </form>
      <br>
      <br>
  </div>
  ...
  <br>
    ...
    <?php
      ...
      echo "<h2 style=\"color:lightgreen\">MEVCUT AMELİYAT RANDEVULARINIZ:</h2>";
...
<div style="position:fixed;top:600px;right:50px;">
  ...
  <button style="position:fixed;top:600px;left:900px;background:lightgreen;height:50px;width:200px;"><font size="3"><a  class="fa fa-wheelchair" href="Ameliyat.php"> Ameliyat ekle</a></font></button>
