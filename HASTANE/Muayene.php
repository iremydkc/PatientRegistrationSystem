...
<div class="w3-container">
    ...
    <div class="w3-card-4" style="position:fixed;top:15px;left:15px;height:12%">
      <div class="w3-container" >
        <h1>Muayene Randevusu Vereceğiniz Hastanın Bilgilerini Ekleyin:</h1>
      </div>

      <form class="w3-container" action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
        <p>
		<i class="fa fa-user-plus" style="font-size:48px;color:lightgreen"></i><label style="color:lightgreen"> Hasta Adı</label>
          <input class="w3-input w3-border" name="hastaad" type="text">
          </p>
        <p>     
		<i class="fa fa-calendar" style="font-size:48px;color:lightgreen"></i><label style="color:lightgreen"> Randevu Tarihi</label>
          <input class="w3-input w3-border" name="randevutarih" type="datetime-local">
          </p>
        <p>
		<i class="fa fa-file-text" style="font-size:48px;color:lightgreen"></i><label style="color:lightgreen"> Kısaca Şikayetler</label>
          <input class="w3-input w3-border" name="kisasikayetler" type="text">
          </p>
        <p>
          <input type="submit" name="ekle_btn" class="w3-btn w3-right w3-large w3-border" style="color:lightgreen" value="EKLE">
        </p>
      </form>
      <br>
      <br>
...
<div class="sidebar" style="top:80px;">
  ...
  <br>
<button style="position:fixed;top:600px;left:900px;background:lightgreen;height:50px;width:200px;"><font size="3"><a  class="fa fa-wheelchair" href="Muayenesil.php"> Randevu iptal</a></font></button>
</div>
